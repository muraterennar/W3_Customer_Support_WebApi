...
public class JWTHelper : ITokenHelper
{
    ...
    public JwtSecurityToken CreateJwtSecurityToken(TokenOptions tokenOptions, SecurityUser user, SigningCredentials signingCredentials, List<OperationClaim> operationClaims)
    {
